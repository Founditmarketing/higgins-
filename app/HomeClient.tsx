...
<p className="gene-body">{c["gen.alex"] ?? "G. Alexander Higgins is the second generation of the firm and its managing partner. He grew up around this work, and he holds his cases to the standard his father set. Clients stay informed at every step, because that is how he was taught to practice."}</p>
</article>
...
<p className="call-lede">{c["call.lede"] ?? "Every case here begins the same way: you tell us what is going on, and we listen. The consultation is free, in person or by video."}</p>
